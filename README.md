...
Estado actual: v1.8.0 — Rediseño moderno de autenticación, branding AquaPanel (logo + colores), redirección con acceso denegado y campos adicionales en registro (nombre y fecha de nacimiento).

• Changelog: ver [v1.8.0 en CHANGELOG.md](CHANGELOG.md#v180---2025-10-25) · Tag: [v1.8.0](https://github.com/jhonatanfdez/symfony-proyecto/releases/tag/v1.8.0)
...
## Funcionalidades actuales (v1.8.0)
